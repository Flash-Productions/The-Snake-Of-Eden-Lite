...
import com.flashproductions.android.games.thesnakeofedenlite.Assets;
...
public class AndroidGraphics implements Graphics
{
    ...
    @Override
    public void drawPixmap ( Pixmap pixmap, int x, int y, int srcX, int srcY, int srcWidth, int srcHeight, int color )
    {
        srcRect.left = srcX;
        srcRect.top = srcY;
    ...
    public void drawText ( String text, int x, int y )
    {
        ...
        paint.setColor ( Color.rgb ( color.nextInt ( 255 ), color.nextInt ( 255 ), color.nextInt ( 255 ) ) );
        paint.setStyle ( Style.FILL );
